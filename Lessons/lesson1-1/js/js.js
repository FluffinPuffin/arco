...
function loadProgress() {
  ...
  if (saved) {
    ...
    partCompleted = data.partCompleted || [false, false, false, false];
...
function saveProgress() {
  ...
  // Also update overall lesson progress for the lessons page
...
function initFinishButtons() {
  ...
  if (nextLessonBtn) {
    nextLessonBtn.addEventListener('click', () => {
      window.location.href = '../../lesson1-2/html/index.html';
    });
  }
}
